<header id="header" class="header" style="background: rgb(8, 11, 108) none repeat scroll 0% 0%;">
            <div class="container">
                
                <!-- Logo -->
                <div class="logo float-left">
                    <a href="<?php echo site_url(); ?>" title=""><img src="<?php echo base_url(); ?>public/images/logo-header.png" alt=""></a>
                </div>
                <!-- End Logo -->
                <!-- Bars -->
                        ...
                        <div class="tb">
                            <div class="tb-cell">
                                <ul class="menu-list text-uppercase">
                                    <li class="<?php echo (strcmp($this->uri->segment(1),'')==0)?'current-menu-parent':''; ?>">
                                        <a href="<?php echo site_url(); ?>" title="">Home</a>
                                       <!--  <ul class="sub-menu">
                                   ...
                                   <!-- < li>
                                    ...
                                    <li class="<?php echo (strcmp($this->uri->segment(1),'hotel')==0)?'current-menu-parent':''; ?>">
                                        <a href="<?php echo site_url(); ?>hotel" title="">Hotel</a>
                                        <!-- <ul class="sub-menu">
                                            <li>
                                    ...
                                    <li >
                                        <a href="<?php echo site_url(); ?>#" title="">About Us</a>                                    
                                    </li>
                                    <li >
                                        <a href="<?php echo site_url(); ?>#" title="">Teams</a>                                    
                                    </li>
                                    <li >
                                        <a href="<?php echo site_url(); ?>#" title="">Contact us</a>                                   
                                    </li>
                                </ul>
                            </div>
                        </div>
